 ...
 * to a another u16 value. This function can be used to convert the result of
 ...
 * values will be mapped to a another u16 value. This function can be used to convert 
